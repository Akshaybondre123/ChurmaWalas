...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-cream-100 via-saffron-50 to-terracotta-100 relative overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute top-40 left-10 w-80 h-80 bg-saffron-500 rounded-full opacity-5 blur-3xl -z-10"></div>
      <div className="absolute bottom-40 right-10 w-80 h-80 bg-terracotta-500 rounded-full opacity-5 blur-3xl -z-10"></div>
      <div className="absolute top-1/3 right-1/4 w-60 h-60 bg-cream-600 rounded-full opacity-5 blur-3xl -z-10"></div>
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center mb-12 relative">
          ...
          <h1 className="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-saffron-600 via-terracotta-500 to-cream-500 mb-4 font-serif relative z-10 drop-shadow-sm">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="relative z-10">
            <div className="absolute -top-6 -left-6 w-24 h-24 bg-terracotta-200 rounded-full opacity-70 -z-10"></div>
            <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-teal-200 rounded-full opacity-70 -z-10"></div>
            <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-saffron-600 to-terracotta-500 mb-6 font-serif">
              Our Colorful Story
            </h2>
            <div className="w-24 h-2 bg-gradient-to-r from-saffron-500 to-terracotta-500 mb-6 rounded-full"></div>
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-saffron-300 to-terracotta-300 rounded-2xl transform rotate-3 scale-95 opacity-40 blur-sm"></div>
...
/>
              ...
              <div className="absolute bottom-4 left-4 right-4 text-white">
                <p className="text-sm font-medium text-cream-300">Our Founder</p>
                <h3 className="text-2xl font-bold">Shri Mohan Singh Rathore</h3>
                <p className="text-white/80 text-sm">Established in 1985</p>
              </div>
            </div>
            <div className="absolute -bottom-4 -right-4 bg-gradient-to-br from-saffron-500 to-terracotta-500 rounded-full p-4 shadow-lg text-white">
              <Sparkles className="h-8 w-8" />
            </div>
          </div>
        </div>

        <div className="relative bg-gradient-to-r from-saffron-500 to-terracotta-500 p-12 rounded-2xl mb-16 overflow-hidden shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
            <Card className="overflow-hidden border-none bg-white/90 backdrop-blur-sm rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="h-3 bg-gradient-to-r from-saffron-500 to-saffron-600"></div>
              <CardContent className="p-6 text-center">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-saffron-500 to-saffron-600 flex items-center justify-center mx-auto mb-4 shadow-lg">
                  <Award className="h-10 w-10 text-white" />
                </div>
                <h3 className="text-2xl font-bold mb-2 text-saffron-700">Authentic Recipes</h3>
            ...
            <Card className="overflow-hidden border-none bg-white/90 backdrop-blur-sm rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="h-3 bg-gradient-to-r from-saffron-600 to-terracotta-500"></div>
              <CardContent className="p-6 text-center">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-saffron-600 to-terracotta-500 flex items-center justify-center mx-auto mb-4 shadow-lg">
                  <Utensils className="h-10 w-10 text-white" />
                </div>
                <h3 className="text-2xl font-bold mb-2 text-terracotta-700">Traditional Cooking</h3>
                <p className="text-gray-600 text-lg">
            ...
            <Card className="overflow-hidden border-none bg-white/90 backdrop-blur-sm rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="h-3 bg-gradient-to-r from-terracotta-500 to-terracotta-600"></div>
              <CardContent className="p-6 text-center">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-terracotta-500 to-terracotta-600 flex items-center justify-center mx-auto mb-4 shadow-lg">
                  <Users className="h-10 w-10 text-white" />
                </div>
                <h3 className="text-2xl font-bold mb-2 text-terracotta-700">Family Atmosphere</h3>
                <p className="text-gray-600 text-lg">
            ...
            <Card className="overflow-hidden border-none bg-white/90 backdrop-blur-sm rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="h-3 bg-gradient-to-r from-terracotta-600 to-cream-500"></div>
              <CardContent className="p-6 text-center">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-terracotta-600 to-cream-500 flex items-center justify-center mx-auto mb-4 shadow-lg">
                  <Clock className="h-10 w-10 text-white" />
                </div>
                <h3 className="text-2xl font-bold mb-2 text-cream-700">Time-Honored Tradition</h3>
                <p className="text-gray-600 text-lg">
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-saffron-600 via-terracotta-500 to-cream-500 mb-8 text-center font-serif">
            Our Culinary Philosophy
          </h2>
          <div className="w-40 h-2 bg-gradient-to-r from-saffron-500 via-terracotta-500 to-cream-500 mx-auto mb-8 rounded-full shadow-sm"></div>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 relative">
              ...
              <div className="relative overflow-hidden rounded-2xl shadow-2xl border-8 border-white transform hover:rotate-2 transition-transform duration-500">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent"></div>
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  <p className="text-sm font-medium text-cream-300">Traditional Methods</p>
              ...
              <div className="absolute -bottom-4 -left-4 bg-gradient-to-br from-terracotta-500 to-cream-500 rounded-full p-4 shadow-lg text-white">
                <ChefHat className="h-8 w-8" />
              </div>
            </div>
            <div className="order-1 md:order-2 relative z-10">
              <div className="absolute -top-6 -left-6 w-24 h-24 bg-terracotta-200 rounded-full opacity-70 -z-10"></div>
              <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-cream-200 rounded-full opacity-70 -z-10"></div>
              ...
              <ul className="space-y-8 mb-6">
                <li className="flex items-start gap-6">
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-saffron-500 to-terracotta-500 flex items-center justify-center flex-shrink-0 mt-1 shadow-lg">
                ...
                <li className="flex items-start gap-6">
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-terracotta-500 to-terracotta-600 flex items-center justify-center flex-shrink-0 mt-1 shadow-lg">
                    <span className="text-white font-bold text-2xl">2</span>
                  </div>
                  <div>
                    <h3 className="font-bold text-2xl text-terracotta-700 mb-2">Quality Ingredients</h3>
                    <p className="text-gray-600 leading-relaxed text-lg">
                ...
                <li className="flex items-start gap-6">
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-terracotta-600 to-cream-500 flex items-center justify-center flex-shrink-0 mt-1 shadow-lg">
                    <span className="text-white font-bold text-2xl">3</span>
                  </div>
                  <div>
                    <h3 className="font-bold text-2xl text-cream-700 mb-2">Innovation with Respect</h3>
                    <p className="text-gray-600 leading-relaxed text-lg">
        ...
        <div className="text-center mb-16 relative">
          <div className="absolute inset-0 bg-gradient-to-r from-saffron-600 to-terracotta-600 rounded-3xl transform -rotate-1 scale-95 opacity-90"></div>
          <div className="relative p-16 rounded-2xl shadow-2xl">
            <div className="absolute -top-8 left-1/2 transform -translate-x-1/2">
              <div className="flex gap-1">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="h-12 w-12 fill-cream-400 text-cream-400 drop-shadow-lg" />
                ))}
              </div>
            </div>
